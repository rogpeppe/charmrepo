...
type Progress interface {
	// Start is called with the its upload id and when the upload
	// starts. The uploadId will be empty when the upload is small
	// and multipart upload is not being used.
